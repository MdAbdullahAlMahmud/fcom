...
import { Phone, Lock, Eye, EyeOff, Shield, ArrowRight, MessageSquare, CheckCircle, KeyRound, ArrowLeft } from 'lucide-react'
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="mb-6">
          <Button
            onClick={() => router.back()}
            variant="ghost"
            className="text-gray-600 hover:text-violet-600 p-2 -ml-2 transition-colors duration-200"
          >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold bg-gradient-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent">
            {step === 'phone' ? 'Reset Password' : 'Verify & Change'}
          </h1>
          <p className="text-gray-600 mt-2">
            {step === 'phone' ? 'Enter your phone number to get started' : 'Enter the OTP and your new password'}
          </p>
        </div>
        ...
        <Card className="backdrop-blur-xl bg-white/80 border-0 shadow-2xl shadow-violet-500/10 rounded-3xl overflow-hidden">
          ...
          <CardHeader className="relative z-10 pb-6">
            <CardTitle className="text-2xl font-semibold text-gray-800 text-center">
              {step === 'phone' ? 'Verify Identity' : 'Set New Password'}
            </CardTitle>
          </CardHeader>
            ...
            {step === 'phone' ? (
              <form onSubmit={handleRequestOTP} className="space-y-6">
                ...
                <div className="bg-violet-50 border border-violet-200 rounded-xl p-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-sm text-violet-800 font-medium">Security Verification</p>
                      <p className="text-xs text-violet-600 mt-1">We'll send a verification code to your registered phone number to confirm your identity before allowing password change.</p>
                    </div>
                  </div>
                </div>
              </form>
              ...
              <form onSubmit={handleChangePassword} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full text-sm text-gray-500 hover:text-violet-600 transition-colors duration-200 flex items-center justify-center"
                >
                ...
                <div className="bg-violet-50 border border-violet-200 rounded-xl p-4">
                  <div className="flex items-start">
                    <Lock className="h-5 w-5 text-violet-600 mt-0.5 mr-3 flex-shrink-0" />
                    <div>
                      <p className="text-sm text-violet-800 font-medium">Password Tips</p>
                      <p className="text-xs text-violet-600 mt-1">Use at least 8 characters with a mix of letters, numbers, and special characters for better security.</p>
                    </div>
                  </div>
                </div>
              </form>
